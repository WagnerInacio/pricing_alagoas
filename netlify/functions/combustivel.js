...
const API_URL = 'http://api.sefaz.al.gov.br/sfz-economiza-alagoas-api/api/public/combustivel/pesquisa';
...
exports.handler = async (event) => {
  ...
  try {
    ...
    return {
      statusCode: 500,
      headers: CORS_HEADERS,
      body: JSON.stringify({ error: 'Erro ao conectar com a API da SEFAZ/AL.', detail: error.message }),
    };
  }
};